...
import { PedidosHabitualesComponent } from './pedidosHabituales.component';

export const routes: Routes = [
    {
        path: '',
        component: PedidosHabitualesComponent
    }
];
...
@NgModule({
    ...
    declarations: [PedidosHabitualesComponent],
    providers: [ListaService]
})
export class PedidosHabitualesModule { }
